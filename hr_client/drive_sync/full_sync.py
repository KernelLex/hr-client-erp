...
_FIELDS = "id,name,mimeType,modifiedTime,webViewLink,thumbnailLink,parents,trashed,lastModifyingUser(emailAddress,displayName)"
_PAGE_SIZE = 1000
...
def _upsert_file(service, item, path_cache):
    ...
    # Folder-based metadata takes priority for new Drive structure
