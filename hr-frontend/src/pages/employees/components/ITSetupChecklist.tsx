    ...
    <div>
      <div className="flex items-center gap-2 mb-3">
        ...
        <div className="w-20 h-1.5 bg-gray-100 rounded-full overflow-hidden">
          <div className="h-full bg-gold-500 rounded-full transition-all" style={{ width: `${Math.round((done / total) * 100)}%` }} />
        </div>
      </div>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                checked ? "bg-gold-50 border border-gold-100" : "bg-white border border-gray-100 hover:bg-gray-50",
            ...
            >
              ...
              <span className={cn("text-xs", checked ? "text-gold-800 font-medium" : "text-gray-600")}>
                {IT_LABELS[key]}
              </span>
            </button>
          )
